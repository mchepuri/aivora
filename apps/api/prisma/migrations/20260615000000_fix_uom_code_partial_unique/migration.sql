...
-- Existing rows have no valid tenant assignment — remove them rather than
-- leaving them permanently invisible behind a real tenant's queries.
DELETE FROM "units_of_measure" WHERE "tenantId" = '';
